...
const axios_1 = __importDefault(__nccwpck_require__(5060));
const errors_1 = __nccwpck_require__(6669);
const instrument_1 = __nccwpck_require__(2488);
/**
...
/* harmony import */ var _slack_webhook__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(2201);


const icon_emoji = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('icon');
const text = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('message');
const channel = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('channel');
const webhook = new _slack_webhook__WEBPACK_IMPORTED_MODULE_1__/* .IncomingWebhook */ .QU(process.env["SLACK_WEBHOOK"]);
function run() {
    webhook.send({
        text,
        channel,
